...
import AntdProListView from '@ant-design/pro-list/es/ListView';
import { useStyle } from '@ant-design/pro-list/es/style/index';
...
>(props: ProListProps<RecordType, U>) {
  ...
  const ListView = virtualList ? VirtualListView : AntdProListView;
