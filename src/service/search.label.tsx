...
import { AutoComplete, Divider, Image, Space, Tag } from 'antd';
...
export declare type SearchLabelProps = FormProps & {
    ...
    <Space style={{ float: 'right' }}>
      ...
      <AutoComplete
        ...
        onSearch={async (value) => {
          onSearch && (await onSearch(value, setGlobalSearchOptions));
        }}
        style={{ width: '320px' }}
      />
    </Space>
