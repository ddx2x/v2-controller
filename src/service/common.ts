...
// // date_format('Y-m-d','1350052653');//很方便的将时间戳转换成了2012-10-11 
// // date_format('Y-m-d H:i:s','1350052653');//得到的结果是2012-10-12 22:37:33
...
//  */
// export function date_format(format: string, timestamp: number) {
//   var a,
