    ...
    routes: [
      ...
      },
      {
        ...
        routes: [
          {
            name: '满减操作新增',
            path: '/marketing/action/add',
            component: './dynamic-view',
            parentKeys: ['/marketing/action'],
            hideInMenu: true,
          },
          {
            name: '满减操作修改',
            path: '/marketing/action/edit',
            component: './dynamic-view',
            parentKeys: ['/marketing/action'],
            hideInMenu: true,
          },
      ...
      {
        name: '匹配条件',
        path: '/marketing/predicate',
        component: './dynamic-view',
        icon: 'mehTwoTone',
        routes: [
          {
            name: '匹配条件新增',
            path: '/marketing/predicate/add',
            component: './dynamic-view',
            parentKeys: ['/marketing/predicate'],
            hideInMenu: true,
          },
          {
            name: '匹配条件修改',
            path: '/marketing/predicate/edit',
            component: './dynamic-view',
            parentKeys: ['/marketing/predicate'],
            hideInMenu: true,
          },
